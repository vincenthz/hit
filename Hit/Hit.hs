...
showDiff rev1 rev2 git = do
    ...
    where
        ...
        printFileMode (NewMode m) = printf "new file mode: %06o\n" m
        printFileMode (OldMode m) = printf "old file mode: %06o\n" m
        printFileMode (UnModifiedMode m) = printf "current file mode: %06o\n" m
        printFileMode (ModifiedMode o n) = printf "file mode: %06o -> %06o\n" o n
